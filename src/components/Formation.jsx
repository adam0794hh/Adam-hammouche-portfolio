...
function Formation({ activeSection, handleClick }) {
    return (
        <section id='formation' className={`formation ${activeSection === 'formation' ? 'show-animate' : ''}`}>
            <h2 className="heading">Ma <span>Formation</span><span className="animate scroll" style={{ '--i': 1 }}></span></h2>
            ...
            <div className="formation-content">
                <h3>Devlopper FrontEnd <span className="animate scroll" style={{ '--i': 3 }}></span></h3>
                ...
                <a href="#Contact" className="forma-btn">Me Contacter <span className="animate scroll" style={{ '--i': 5 }}></span></a>
            </div>
